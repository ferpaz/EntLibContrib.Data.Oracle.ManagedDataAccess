using EntLibContrib.Data.Oracle.ManagedDataAccess.Configuration;
...
namespace EntLibContrib.Data.Oracle.ManagedDataAccess
{
    ...
    public class OracleDatabase : Database
    {
        ...
        private readonly IEnumerable<IOraclePackage> _packages;
...
#pragma warning restore 612, 618
        ...
        {
            return value is DBNull || (value == null) ? Convert.DBNull : ((bool)value ? 1 : 0);
        }
        ...
        {
            return command.Parameters.Cast<OracleParameter>().Any(parameter => parameter.OracleDbType == OracleDbType.RefCursor);
        }

        /// <devdoc>
        /// Listens for the RowUpdate event on a data adapter to support UpdateBehavior.Continue
        /// </devdoc>
        private static void OnOracleRowUpdated(object sender, OracleRowUpdatedEventArgs args)
        {
